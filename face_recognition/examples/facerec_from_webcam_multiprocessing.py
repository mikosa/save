...
def capture(read_frame_list, Global, worker_num):
    ...
    video_capture.set(3, 1280)  # Width of the frames in the video stream.
    video_capture.set(4, 660)  # Height of the frames in the video stream.
...
if __name__ == '__main__':
    ...
    # # Load a sample picture and learn how to recognize it.
    # leo_image = face_recognition.load_image_file("leo.jpg")
